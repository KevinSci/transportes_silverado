...
urlpatterns = [
    ...
    path('maintenance/edit/<int:service_id>/', user_passes_test(is_staff_user)(views.edit_maintenance_service), name='edit_maintenance'),
    path('maintenance/delete/<int:service_id>/', user_passes_test(is_staff_user)(views.delete_maintenance_service), name='delete_maintenance'),
